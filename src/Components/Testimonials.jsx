...
const Testimonials = () => {
  return (
    ...
    <p className='text-center text-gray-500 mb-12 max-w-800 mx-auto'>Real Stories from those who Found Home with Us</p>  

    <div className='flex flex-wrap justify-center gap-8'>
    {testimonialsData.map((testimonial, index)=>(
        <div key={index} className='max-w-[320px] bg-white shadow-lg rounded px-8 py-12 text-center'>
